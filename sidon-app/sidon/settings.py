"""
Django settings for sidon project.
...
SECRET_KEY = 'eio&o8gs-*)on_la5wl8egcrsm^l&k81wp+8wrd%bdi8-%dykw'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['15.188.48.8', 'localhost', '127.0.0.1']
...
WSGI_APPLICATION = 'sidon.wsgi.application'
